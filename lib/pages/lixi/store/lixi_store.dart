...
part 'lixi_store.g.dart';

class LixiStore = _LixiStore with _$LixiStore;

abstract class _LixiStore with Store, BaseStoreMixin {
  ...
  Future<void> joinRoom(BuildContext context) async {
    await _baseAPI.fetchData(ManagerAddress.luckyMoneyJoinRoom,
        ...
        body: {
          'ownerAcctNo': accountNumberController.text.toString(),
        }).then((value) async {
            ...
            try {
              ...
              if (result.succeeded == true) {
                ...
                BaseNavigation.push(context,
                    routeName: ManagerRoutes.lixiReceive);
              } else {
